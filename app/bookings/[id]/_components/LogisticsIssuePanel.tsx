...
export default function LogisticsIssuePanel({ bookingId, stage, stored, disputed, recipientId, userId, canResolve, receiptConfirmed = false, hasDepositClaim = false }: {
  bookingId: string;

...
export default function FinalSettlementSummary(p: Props) {
  ...
  return <section className="rounded border bg-white p-4 space-y-4">
    ...
    <p className="text-xs text-gray-600">Kwoty przekazane właścicielowi dotyczą jego salda Stripe. Wypłata na rachunek bankowy jest osobnym etapem. Potwierdzenie zwrotu nie oznacza jeszcze zaksięgowania go w banku najemcy.</p>
    {ownerTotal === null && <p className="text-sm text-amber-800">Brakuje pełnych danych o transferach. Łączna kwota nie została potwierdzona.</p>}
  </section>;
}
